...
<div class="sidebar-widget widget-trending">
    <h3 class="widget-title"><span><?php esc_html_e('Trending Now', 'globalnews-media'); ?></span></h3>
...
<div class="sidebar-widget widget-social-follow">
    <h3 class="widget-title"><span><?php esc_html_e('Follow Us', 'globalnews-media'); ?></span></h3>
...
<div class="sidebar-widget widget-newsletter-mini">
    <h3 class="widget-title"><span><?php esc_html_e('Newsletter', 'globalnews-media'); ?></span></h3>
    <div class="newsletter-mini">
        <p><?php esc_html_e('Get the latest news delivered to your inbox.', 'globalnews-media'); ?></p>
        <form action="#" method="post" class="newsletter-mini-form">
            <input type="email" name="nl_email" placeholder="<?php esc_attr_e('Your email', 'globalnews-media'); ?>" required>
